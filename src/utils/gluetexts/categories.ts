...
export default [
    {
        ...
        categoryName: "Salsas de frutas 3 usos",
        descriptionBody:
            "Deliciosa salsa de frutas 3 usos 100% natural para usar como aromática líquida, mermelada y aderezo para la comida.",
        // descriptionBodyAlt:
        //     "También tenemos salsas de fruta sin ningún tipo de endulzante. Sin colorantes, saborizantes, ni conservantes artificiales. Seis deliciosos sabores: Mora, Lulo, Tamarindo, Arazá, Uchuva y Lulo-Arazá.",
        title: "NUESTROS PRODUCTOS 100% NATURNIA",
        usage: {
            title: "Sabores:",
            usages: ["Mora, Lulo, Tamarindo, Arazá, Uchuva y Lulo-Arazá"],
        },
    },
    {
        ...
        title: "100% DE ORIGEN",
        usage: {
            title: "Tres experiencias de bienestar:",
            usages: [
                "Respira: relájate y percibe mejor los aromas de la naturaleza",
                "Renuévate: energizante natural, activa tu vida",
                "Ligereza: mejor digestión para tu día",
            ],
        },
    },
    {
        ...
        descriptionBody:
            "Humecta tus labios y protégelos del sol y del viento. Elaborado con caléndula, manzanilla y extractos botánicos 100% natural.",
        title: "NATURALMENTE",
        usage: {
            usages: ["Hidrata", "Protege", "Nutre"],
        },
    },
];
